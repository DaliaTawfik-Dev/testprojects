    ...
    <div class="main-sidemenu">
        ...
        <ul class="side-menu">
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ route('post.index') }}">postat</a></li>
                    <li><a class="slide-item" href="{{ route('go.index') }}">goes</a></li>
                    <li><a class="slide-item" href="{{ route('next.index') }}">nexes</a></li>
